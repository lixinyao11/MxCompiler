...
public class MxParser extends Parser {
	...
	public static final int
		...
		RULE_returnType = 4, RULE_paraList = 5, RULE_suite = 6, RULE_statement = 7, 
		RULE_varDef = 8, RULE_type = 9, RULE_typeName = 10, RULE_baseType = 11, 
		RULE_expression = 12, RULE_primary = 13, RULE_literal = 14;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "classDef", "classBuild", "funDef", "returnType", "paraList", 
			"suite", "statement", "varDef", "type", "typeName", "baseType", "expression", 
			"primary", "literal"
		};
	}
